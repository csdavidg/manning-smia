...
public class OrganizationChangeHandler {
    ...
    public void loggerSink(OrganizationChangeModel organization) {
        ...
        switch (organization.getAction()) {
            ...
            case "SAVE":
                ...
                updateRedisValue(organization.getOrganizationId());
                break;
            case "UPDATE":
    ...
    private void updateRedisValue(String orgId) {
        Organization organizationResponse = organizationRestTemplateClient.requestInformationFromOrganizationService(orgId);
        redisRepository.save(organizationResponse);
    }
